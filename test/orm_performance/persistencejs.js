const persistence      = require('persistencejs/lib/persistence').persistence
    , persistenceStore = require("persistencejs/lib/persistence.store.postgres")

var LIMIT = 10000

persistence.debug = false
persistenceStore.config(persistence, 'localhost', 5432, 'performance_analysis_sequelize', 'postgres', 'admin')
